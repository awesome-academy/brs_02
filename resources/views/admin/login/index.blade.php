            ...
            <div class="login-box">
                ...
                {!! Form::open(['method'=> 'POST', 'route'=> ['admin.login.index'] ]) !!}
                        ...
                        <div class="input-prepend" title="Username">
                            {!! Form::text( 'username', old('username'), ['class'=>'input-large span10','placeholder'=>'Username']) !!}
                        </div>

                        <div class="clearfix"></div>

                        <div class="input-prepend" title="Password">
                            {!! Form::text( 'password', old('password'), ['class'=>'input-large span10','placeholder'=>'Password']) !!}
                        </div>
